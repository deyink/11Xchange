...
const SplashScreen = () => {
  ...
  return (
    <View style={{backgroundColor:'#5072A7', padding:2, height:'100%', width:'100%'}} >
        ...
        <TouchableOpacity style={{padding:20, backgroundColor:'white', width:'90%', marginHorizontal:'auto', borderRadius:13     }} >
            <Text style={{textAlign:'center', fontSize:16 }} >
                Get Started
            </Text>
        </TouchableOpacity>

        <Text style={{textAlign:'center', color:'white', top:'17%' }} > A Currency Converter Project, Design and Implemented By {'\n'}  Fss/comp/com321/GRP11 {'\n'}   ©️ </Text>
